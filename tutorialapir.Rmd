...
Para obtener los datos de una tabla es necesario conocer su código identificativo (vea [códigos identificadores de tablas y series](https://uvima.github.io/datalab/api-json/codigos_identificadores.html)).

Una vez se conoce el código de la tabla de interés, se puede utilizar la función [get_data_table()](https://uvima.github.io/ineapir/reference/get_data_table.html) para obtener los datos asociados.
...
1. Obtener información de las variables y valores

```{r tabla5, exercise=TRUE}
metadata <- get_metadata_table_varval(idTable = 50902)
metadata
```

2. Construimos el filtro y pedimos los datos. Por ejemplo, para la variación anual ("3" = "74") del índice general ("762" = "304092").
...
Una vez se conoce el código de la serie de interés, se puede utilizar la función [get_data_series()](https://uvima.github.io/ineapir/reference/get_data_series.html) para obtener los datos de interés.
...
Se pueden obtener las variables del Sistema utilizando la función [get_metadata_variables()](https://uvima.github.io/ineapir/reference/get_metadata_variables.html).
...
Se pueden obtener los valores de una variable utilizando la función [get_metadata_values()](https://uvima.github.io/ineapir/reference/get_metadata_values.html).
...
En lo que se refiere a las tablas, se puede obtener un listado de las tablas de una operación con la función [get_metadata_tables_operation()](https://uvima.github.io/ineapir/reference/get_metadata_tables_operation.html) y también las variables y valores que la definen con las funciones [get_metadata_table_groups()](https://uvima.github.io/ineapir/reference/get_metadata_table_groups.html) y [get_meteadata_table_values()](https://uvima.github.io/ineapir/reference/get_metadata_table_values.html).
...
Alternativamente, podemos utilizar la función [get_metadata_table_varval()](https://uvima.github.io/ineapir/reference/get_metadata_table_varval.html) en un sólo paso.
...
En lo que se refiere a las series, se puede obtener información de una serie con la función [get_metadata_series()](https://uvima.github.io/ineapir/reference/get_metadata_series.html), así como de las variables y valores que la definen con la función [get_metadata_series_values()](https://uvima.github.io/ineapir/reference/get_metadata_series_values.html). Además, también se puede obtener un listado de las series de una tabla con la función [get_metadata_series_table()](https://uvima.github.io/ineapir/reference/get_metadata_series_table.html) y un listado de las series de una operación [get_metadata_series_operation(()](https://uvima.github.io/ineapir/reference/get_metadata_series_operation.html).
...
Se puede obtener un listado de las todas las publicaciones del sistema con la función [get_metadata_publications()](https://uvima.github.io/ineapir/reference/get_metadata_publications.html). Además, también se pueden consultar las fechas de publicación de una publicación en particular con la función [get_metadata_publication_dates()](https://uvima.github.io/ineapir/reference/get_metadata_publication_dates.html).
